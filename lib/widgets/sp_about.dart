      ...
      page = CustomScrollView(
        ...
        slivers: <Widget>[
          MorphingSliverAppBar(
            ...
            title: _PackageLicensePageTitle(title, subtitle),
          ),
          SliverPadding(
            padding: padding,
            sliver: SliverList(
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        Text(subtitle, style: M3TextTheme.of(context).bodyMedium),
      ],
    );
  }
}
            ...
            : _MasterPage(
                leading: widget.leading ??
                    (widget.automaticallyImplyLeading && Navigator.of(context).canPop()
                        ? SpPopButton(onPressed: () => Navigator.of(context).pop())
                        : null),
                title: widget.title,
        ...
        SafeArea(
          child: Padding(
            padding: EdgeInsetsDirectional.only(
              ...
              end: widget.floatingActionButton == null ? detailPageFABlessGutterWidth : detailPageFABGutterWidth,
            ),
